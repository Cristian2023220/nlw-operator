...
# 1. Pega a pasta onde este script está (core)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# 2. Sobe APENAS UMA pasta para chegar na raiz do 'computer_vision_app'
PROJECT_ROOT = os.path.abspath(os.path.join(BASE_DIR, ".."))

# 3. Entra na pasta models corretamente
MP_MODEL_PATH = os.path.join(PROJECT_ROOT, "models", "gesture_recognizer.task")
CUSTOM_MODEL_PATH = os.path.join(PROJECT_ROOT, "models", "gesture_model.joblib")
